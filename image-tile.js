class LightboxTile extends HTMLElement {
  connectedCallback() {
    ...
    this.innerHTML = `
      <div class="bg-blue-100 border border-blue-500 p-8 rounded-lg shadow-md hover:shadow-lg hover:-translate-y-1 transition transform cursor-pointer h-full flex flex-col">
